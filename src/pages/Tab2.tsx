...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonAlert, IonItem, IonRow, IonList
    , IonText, IonCol, IonButton, IonIcon, IonLabel, IonSearchbar, IonModal, IonGrid, IonCardSubtitle, IonCardTitle, IonFooter } from '@ionic/react';
import './Tab2.css';
import update from 'immutability-helper';
import { Store, o_type, getGoods, t_good, getData } from './Store'
import { listOutline, ellipsisHorizontalOutline, cartOutline, closeOutline, removeCircleOutline, addCircleOutline, giftOutline, arrowBack, arrowBackOutline } from 'ionicons/icons';
...
function        BItem(props:{info : t_good}):JSX.Element{
  ...
  return <>
    <IonRow class="r-underline">
      <IonCol><IonIcon id="a-margin" icon={ giftOutline }/></IonCol>
      <IonCol size="8">
    ...
    <IonPage>
      ...
      <IonModal
        ...
        onDidDismiss={() => setBasket( false )}>
          ...
          <IonHeader>
            <IonToolbar>
              <IonButton fill="clear" slot="start" onClick={() => setBasket(false)}>
